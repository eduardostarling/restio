...
.. code-block:: python
    ...
    model_retrieved = await transaction.get(Model, key=5)  # key is 5, _internal_id is ddc59b7e-9ad9-48cc-9361-fcd2b901e657
    ...
    new_model_retrieve = await transaction.get(Model, key=1234)  # key is 1234, _internal_id is cad0d71c-dc4d-4722-adf1-712d798bdfdb
